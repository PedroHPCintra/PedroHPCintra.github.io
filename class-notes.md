...
- [Where does the logistic model comes from?](./class-notes/en/logistic-model-master-eq.md): A brief introduction on master equations in ecology and the conection of individual dynamics and population level descriptions.